...
<body>
	...
	<section class="category">
		<div class="container">
			...
			@if ($category->ok == null)
				<a href="#" class="category-item wow fadeInUp" data-wow-delay=".3s">
		...
		@foreach ($second_sliders as $second_slider)
			<div class="container">
				...
				<div class="war__img wow fadeIn" data-wow-delay=".4s">
					<img src="{{$second_slider->photos[0]}}" alt="toy">
				</div>
				
				<div class="war-helicopters">
						@foreach ($second_slider->photos as $photo)
							<img src="{{$photo}}" alt="helicopter" id="helicopter1">
							{{-- <img src="issets/img/war/helicopter2.png" alt="helicopter" id="helicopter2"> --}}
						@endforeach
					</div>
			</div>
		@endforeach
	...
	<section class="instagram">
		<div class="container">
			...
			<div class="instagram-wrap">
				...
				<a href="{{$instagram_slider->link}}}" class="instagram-item wow fadeInUp" target="_blank" rel="nofollow" data-wow-delay=".3s">
