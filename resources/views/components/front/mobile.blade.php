    ...
    <div class="mobile-menu__wrap">
        <div class="mobile-menu__head">
            ...
            <a href="tel:+9999" class="mobile-menu__call">
                <img src="../../../issets/img/icons/call-red.svg" alt="ico">
            </a>
        </div>
            ...
            <li>
                <a href="#" target="_blank" rel="nofollow">
                    <svg width="21" height="21" viewBox="0 0 21 21" fill="none"
                        ...
                        <path
                            d="M20.5 10.5C20.5 5 16 0.5 10.5 0.5C5 0.5 0.5 5 0.5 10.5C0.5 15.5 4.125 19.625 8.875 20.375V13.375H6.375V10.5H8.875V8.25C8.875 5.75 10.375 4.375 12.625 4.375C13.75 4.375 14.875 4.625 14.875 4.625V7.125H13.625C12.375 7.125 12 7.875 12 8.625V10.5H14.75L14.25 13.375H11.875V20.5C16.875 19.75 20.5 15.5 20.5 10.5Z"
                            fill="currentColor" />
                    </svg>
                </a>
            </li>
        ...
        <div class="mobile-menu__lang">
            @if ($lang != 'ru')
                <a href="/languages/ru" class="current">Русский</a>
            @endif
            @if ($lang != 'uz')
                <a href="/languages/uz" class="current">O’zbek</a>
            @endif
            @if ($lang != 'en')
                <a href="/languages/en" class="current">English</a>
            @endif
        </div>
