    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <form action="{{ route('dashboard.instagramslider.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            @foreach ($sliders as $key => $slider)
                                <tr>
                                    <th scope="row">{{ ++$key }}</th>
                                    <td><img src="{{ $slider->photo }}" alt="" style="width: 100px; height: 100px;"></td>
                                    <td>{{ $slider->link }}</td>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('dashboard.instagramslider.update', $slider) }}"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form
                                                            action="{{ route('dashboard.instagramslider.destroy', $slider->id) }}"
                                                            method="post">
                                                            @csrf
                                                            {{ method_field('delete') }}
