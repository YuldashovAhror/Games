                        ...
                        <tbody>
                            @foreach ($clients as $key => $client)
                                <tr>
                                    ...
                                    <td ><a
                                        href="{{$client->photo}}"><button
                                            class="btn btn-primary"><i class="bx bxs-file-doc"></i>Файл</button></a></td>
                                    <td class="text-center">
                                        ...
                                        <button class="btn btn-xs btn-danger" type="button" data-bs-toggle="modal"
                                            data-bs-target="#exampleModalCenter{{ $client->id }}"><i
                                                class="bx bx-trash"></i>Удалить</button>
                                        <div class="modal fade" id="exampleModalCenter{{ $client->id }}"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form
                                                            action="{{ route('dashboard.client.destroy', $client->id) }}"
                                                            method="post">
                                                            @csrf
                                                            {{ method_field('delete') }}
